...
```bash
cd cache     && make up && make break && make test && make down
cd ratelimit && make up && make break && make test && make down
cd locks     && make up && make break && make test && make down
cd streams   && make up && make break && make test && make down
cd pubsub    && make up && make break && make test && make down
```
